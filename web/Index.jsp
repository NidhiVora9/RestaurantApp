...
<div class="container-fluid">
	<div class="row text-center">
		...
		<div class="col-sm-4 offers">
			...
			<span>Two medium two topping pizzas for <h1>$6.99</h1></span>
			<button class="btn btn-success" value="Learn More">Learn More</button>
		</div>
		<div class="col-sm-4 offers">
			<img src="images/offers/offer_3.jpg" width="300" height="250">
			<h3>Brownie</h3>
			<span>Try our double chocolate chip brownie <h1>$6.99</h1></span>
			<button class="btn btn-success" value="Learn More">Learn More</button>
		</div>
	</div>
...
#gmap_canvas img {
	...
	<script type='text/javascript'>
		function init_map() {
			var myOptions = {
				zoom : 10,
				center : new google.maps.LatLng(41.1682883, -73.19323279999998),
			...
			marker = new google.maps.Marker({
				map : map,
				position : new google.maps.LatLng(41.1682883,
						-73.19323279999998)
			});
			infowindow = new google.maps.InfoWindow(
					{
						content : '<strong>Arthur\'s Famous Pizza</strong><br> 430 Park Ave, Bridgeport, CT 06604<br>'
					});
